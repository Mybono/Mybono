...
<br><br>С университета влюблен в it, жизнь связала меня с качеством и оптимизацией. На текущем месте работы занимаюсь оптимизацией бизнес процессов, ищу и исправляю "баги". Внедряю проекты бережливого производства на своем предприятии. Вот несколько моих любимых проектов утвержденных по моей инициативе:
...
+ **Равномерное распределение работ в отделе снабжения.** Программа информирует о загруженности сотрудников, помогает распределять работы, позволяет сотрудникам работать в команде, отслеживать процессы закупок на всех этапах. Расставлять приоритеты правильно. 
